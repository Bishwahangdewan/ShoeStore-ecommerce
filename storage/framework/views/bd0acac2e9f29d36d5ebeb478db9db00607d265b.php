    ...
    <?php if(count($item) > 0): ?>
    <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oneitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="home-container py-5">
            <div class="row">
                <div class="col-md-6">
                    <img class="img-fluid" src="/img/<?php echo e($oneitem->img); ?>">
                </div>
                <div class="col-md-6 pl-5">
                    <h1 class="display-4 mb-3"><?php echo e($oneitem->name); ?></h1>
                    <div class="d-flex flex-column flex-sm-row justify-content-between">
                        <ul class="list-inline">
                            <li class="list-inline-item h4">$:<?php echo e($oneitem->price); ?></li>
                        ...
                        <form method="GET" action="/cart" class='pt-4' id="itemdetail">
                            <div class="row">
                                ...
                                <input type="text" class="invisible" name="product_id" value="<?php echo e($oneitem->id); ?>">
                            ...
                            <div class="container">
                                ...
                                <div class="tab-content py-3">
                                    <div id="description" class="tab-pane active">
                                        <p class="lead"><?php echo e($oneitem->description); ?></p>
                                    </div>
                                                ...
                                                <table class = "table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-muted"><?php echo e($oneitem->gender); ?></td>
                                                        </tr>
        
                                                        <tr>
                                                            <th class="text-uppercase">BRAND</th>
                                                            <td class="text-muted"><?php echo e($oneitem->brand); ?></td>
                                                        </tr>
        
                                                        <tr>
                                                            <th class="text-uppercase">LIFESTYLE</th>
                                                            <td class="text-muted"><?php echo e($oneitem->type); ?></td>
                                                        </tr>
        
                                                        <tr>
                                                            <th class="text-uppercase">MATERIAL</th>
                                                            <td class="text-muted"><?php echo e($oneitem->material); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
...
<?php /* C:\xampp\htdocs\ecommerce\resources\views/checkout/itemdetails.blade.php */ ?>