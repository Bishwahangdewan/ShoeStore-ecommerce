...
<head>
	...
	<title><?php echo e(config('app.name','ShoeStore')); ?></title>
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/app.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/credit.css')); ?>">
</head>
<body>
	...
	<div class="container">
        ...
        <h1 class="text-center my-5">Enter credit details <?php echo e($name->name); ?></h1>
	...
	<script src="<?php echo e(asset('js/charge.js')); ?>"></script>
	
</body>
</html>
<?php /* C:\xampp\htdocs\ecommerce\resources\views//payment/credit.blade.php */ ?>